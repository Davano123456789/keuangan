    ...
    <div class="row">
        ...
        <div class="card tale-bg">
            ...
            <div class="weather-info">
                ...
                <h6 class="font-weight-normal mb-0" style="font-size: 0.85rem; opacity: 0.85;">Total Saldo — Semua Dompet</h6>
                <h3 class="mb-0 font-weight-bold" style="font-size: clamp(1rem, 4vw, 1.6rem); word-break: break-word; white-space: normal;">
        ...
        <div class="row">
            ...
            <div class="card card-tale">
                ...
                <p class="fs-20 mb-2">Rp {{ number_format($incomeThisMonth, 0, ',', '.') }}</p>
                <p>Keseluruhan</p>
                </div>
            </div>
            </div>
            ...
            <div class="card card-dark-blue">
                ...
                <p class="fs-20 mb-2">Rp {{ number_format($expenseThisMonth, 0, ',', '.') }}</p>
                <p>Keseluruhan</p>
                </div>
            </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="card card-light-blue">
                ...
                <p class="fs-20 mb-2">{{ $walletCount }}</p>
            ...
            <div class="card card-light-danger">
                ...
                <p class="fs-20 mb-2">{{ count($recentTransactions) }}</p>
                <p>Riwayat Terbaru</p>
                </div>
            </div>
            </div>
